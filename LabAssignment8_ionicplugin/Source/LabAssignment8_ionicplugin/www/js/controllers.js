...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $http, $location , $cordovaOauth ) {
  ...
  $scope.doLogin = function() {
    console.log('Doing login', $scope.loginData);
       $cordovaOauth.google("147550301893-8e1q1365pijfr823lqmb2ol1a0phk07g.apps.googleusercontent.com", ["https://www.googleapis.com/auth/urlshortener", "https://www.googleapis.com/auth/userinfo.email"]).then(function(result) {
